...
//
// copy the wall data to tilemap & actorat
//
...
//
// TODO: fix demo support for Spear
//
...
//
    ...
    FizzleFade ((long)bufferofs - SCREENSEG,(long)displayofs - SCREENSEG + screenofs,viewwidth,viewheight,70,false);
    ...
    if (!tedlevel)          // SO'S YA DON'T GET KILLED WHILE LAUNCHING!
        gamestate.lives--;
...
startplayloop:
        ...
        switch (playstate)
        {
            ...
            case ex_secretlevel:
...
#if defined(SPEARDEMO) || defined(JAPDEMO)
                ...
                else if (playstate == ex_secretlevel)                       // GOING TO SECRET LEVEL
                    gamestate.mapon = 9;
                else
                    gamestate.mapon++;                                      // GOING TO NEXT LEVEL
#else
                //
                ...
                else if (gamestate.mapon == 18 || gamestate.mapon == 19)
                {
                    //
                    // COMING BACK FROM SECRET LEVEL
                    //
