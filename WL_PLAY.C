...
int         lastmusicchunk = -1;

int         DebugOk;

objtype     objlist[MAXACTORS],dummyobj;
int         objcount;
objtype     *newobj,*player,*lastobj,*objfreelist,*killerobj;

word    	farmapylookup[MAPSIZE];
...
word    	uwidthtable[UPDATEHIGH];
word     	blockstarts[UPDATEWIDE*UPDATEHIGH];
